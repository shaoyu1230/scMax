...
for (sample in samples) {
	...
	if ("Contamination" %in% names(sample_meta@meta.data)){sample_data$Contamination <- as.character(nrow(subset(sample_meta@meta.data,Contamination >= decontX)))}else{sample_data$Contamination <- 0}
